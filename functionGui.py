...
def enableRadioButtons(self):
    ...
    self.checkSpecTarget5.setEnabled(True)
    self.checkSpecTarget6.setEnabled(True)
    ...
    self.checkSpecReference5.setEnabled(True)
    self.checkSpecReference6.setEnabled(True)
...
def comparisonRules(self): # to define which reference buttons are checked or not
    if ( self.checkSpecTarget1.isChecked() ): # RECO
        ...
        self.checkSpecReference5.setEnabled(False)
        self.checkSpecReference6.setEnabled(False)
    elif ( self.checkSpecTarget5.isChecked() ): # PU140
        ...
        self.checkSpecReference5.setEnabled(True)
        self.checkSpecReference6.setEnabled(False)
    elif ( self.checkSpecTarget6.isChecked() ): # PU200
