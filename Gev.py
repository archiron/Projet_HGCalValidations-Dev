...
class Gev(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle(self.version) # PU140/PU200 integration. Bug correction : when we have PU200 into GT, the boolean c_PU200 
        # is put to True, introducing error. Corrected with the split of the item
    ...
    def radio13Clicked(self):
        ...
        #self.my_choice_ref_0 = self.my_choice_rel_0 # need to see if we have to keep it # TEMP
    ...
    def checkSpecTarget5_Clicked(self):
        self.checkSpecTarget5.setChecked(True)
        self.validationType2 = 'PU140'
        self.checkSpecReference5_Clicked()
        getCheckedOptions(self)
        comparisonRules(self)
        self.wp.write("Target, self.validationType2 : %s\n " % self.validationType2)
        self.textReport += "Target, self.validationType2 : " + self.validationType2 + "<br>"
    ...
    def checkSpecTarget6_Clicked(self):
        self.checkSpecTarget6.setChecked(True)
        self.validationType2 = 'PU200'
        self.checkSpecReference6_Clicked()
        getCheckedOptions(self)
        comparisonRules(self)
        self.wp.write("Target, self.validationType2 : %s\n " % self.validationType2)
        self.textReport += "Target, self.validationType2 : " + self.validationType2 + "<br>"
    ...
    def checkSpecReference5_Clicked(self):
        self.checkSpecReference5.setChecked(True)
        self.validationType3 = 'PU140'
        getCheckedOptions(self)
        if ( self.checkSpecTarget5.isChecked() ): # PU140 vs PU140
            if ( self.radio13.isChecked() ): # Fast vs full same release
                changeRef2Tmp(self)
            else: # Full vs Full or Fast vs Fast
                changeTmp2Ref(self)
    ...
    def checkSpecReference6_Clicked(self):
        self.checkSpecReference6.setChecked(True)
        self.validationType3 = 'PU200'
        getCheckedOptions(self)
        if ( self.checkSpecTarget6.isChecked() ): # PU200 vs PU200
            if ( self.radio13.isChecked() ): # Fast vs full same release
                changeRef2Tmp(self)
            else: # Full vs Full or Fast vs Fast
                changeTmp2Ref(self)
    ...
    def ItemRelRefClicked1(self):
        ...
        if self.QGBox_rel0.title() == "Reference list":
            ...
            if (checkFastvsFull(self)):
                ...
                print "=========="
                print "self.my_choice_ref_0 :", self.my_choice_ref_0
                print "self.releasesList_ref_1 : ", self.releasesList_ref_1
                print "self.ref_list_0 :", self.ref_list_0
                print "=========="
