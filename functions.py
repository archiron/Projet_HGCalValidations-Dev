...
def clean_collections2(collectionItem, validationType_1, validationType_2, validationType_3, relrefChoice):
    ...
    #print("clean_collection2 :: collectionItem : ", collectionItem)
    #print("clean_collection2 :: validationType_1 : ", validationType_1)
    #print("clean_collection2 :: validationType_2 : ", validationType_2)
    #print("clean_collection2 :: validationType_3 : ", validationType_3)
    #print("clean_collection2 :: relrefChoice : ", relrefChoice)
    item_parts = explode_item(collectionItem)
    #print("items : ", item_parts)
    #print('item 0 :', item_parts[0])
    #print('item 1 :', item_parts[1])
    #print('item 2 :', item_parts[2])
    item_p2 = item_parts[2].split('_', 1)[0]
    #print("item_p2 : ", item_p2)
    ...
    c_Fast = False
    if ( re.search('Fast', item_p2) ): #  match Fast 
        c_Fast = True
    c_PU25 = False
    if ( re.search('PU25', item_p2) ): #  match PU AND PUpmx
        c_PU25 = True
        #print("c_PU25 True") # OK
    c_pmx25 = False
    if ( re.search('PUpmx25', item_p2) ): #  match pmx
        c_pmx25 = True
    c_PU140 = False
    if ( re.search('PU140', item_p2) ): #  match PU AND PUpmx
        c_PU140 = True
    c_PU200 = False
    if ( re.search('PU200', item_p2) ): #  match PU AND PUpmx
        c_PU200 = True
    
    if ( valType == "PU25" ): # PU test (PU and not pmx)
        #print("valType OK", temp)
        if ( not c_PU25 ):
            temp = False
    else: # valType != "PU25"
        if (c_PU25):
            temp = False
    #print("temp PU25 : ", temp)
    ...
    if ( valType == "PU140" ): # PU test (PU and not pmx)
        if ( not c_PU140 ):
            temp = False
    else: # valType != "PU140"
        if (c_PU140):
            temp = False
    #print("temp apres PU140 : ", temp)
    
    if ( valType == "PU200" ): # PU test (PU and not pmx)
        print("valType = PU200")
        if ( not c_PU200 ):
            temp = False
    else: # valType != "PU200"
        print("valType <> PU200")
        if (c_PU200):
            #print("c_PU200 : ", c_PU200)
            temp = False
    #print("temp apres PU200 : ", temp)
...
def list_search_5(self):
    ...
    print("list_search_5 : self.validationType1 = %s\n " % self.validationType1)
    print("list_search_5 : self.validationType2 = %s\n " % self.validationType2)
    print("list_search_5 : self.validationType3 = %s\n " % self.validationType3)
    ...
    print("list_search_5 : self.selectedDataSets = %s\n " % str(self.selectedDataSets))
    print("list_search_5 : filtre = %s\n " % str(filtre))
    validationType_2 = self.validationType2
    validationType_3 = self.validationType3
    
    # DATASET
    #print("list_search_5 : self.rel_list_1 = %s\n " % str(self.rel_list_1))
    #print("list_search_5 : self.ref_list_1 = %s\n " % str(self.ref_list_1))
    ...
    print("list_search_5 : self.rel_list_2 = %s\n " % str(self.rel_list_2))
    print("list_search_5 : self.ref_list_2 = %s\n " % str(self.ref_list_2))
    
    # PART RELEASE
    #print("list_search_5 : self.releasesList_rel_2 = %s\n " % str(self.releasesList_rel_2))
    ...
    for item1 in self.releasesList_rel_2:
        for item2 in filtre:
            if (re.search(item2 + '__', item1) and re.search(str(self.my_choice_rel_1) + '-', item1)):
                print("release :: item1 : ", item1, "  -  item2 : ", item2)
        ...
        for item1 in releasesTemp:
            for item2 in filtre:
                if (re.search(item2 + '__', item1) and re.search(str(self.my_choice_ref_1) + '-', item1)):
                    print("reference :: item1 : ", item1, "  -  item2 : ", item2)
...
def getCheckedOptions(self):
    ...
    elif self.checkSpecTarget5.isChecked():
        self.validationType2 = 'PU140'
    elif self.checkSpecTarget6.isChecked():
        self.validationType2 = 'PU200'
    ...
    elif self.checkSpecReference5.isChecked():
        self.validationType3 = 'PU140'
    elif self.checkSpecReference6.isChecked():
        self.validationType3 = 'PU200'
